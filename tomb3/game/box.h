...
void CreatureAIInfo(ITEM_INFO* item, AI_INFO* info, bool targetLaraByDefault = true, short maxDetectAngle = ANGLE(90));
...
void CreatureJoint(ITEM_INFO* item, short joint, short required, short maxDiffAngle = ANGLE(5), short maxRotAngle = ANGLE(67));
