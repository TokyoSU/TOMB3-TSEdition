...
static void BaddyObjects()
{
	...
	if (obj->loaded)
	{
		...
		obj->hit_points = 100;
		obj->radius = 102;
		obj->bite_offset[0] = AUTOGUN_LEFT_BITE;
		obj->bite_offset[1] = AUTOGUN_RIGHT_BITE;
		obj->intelligent = 1;
		obj->non_lot = 1;
		obj->save_position = 1;
		obj->save_hitpoints = 1;
	...
	if (obj->loaded)
	{
		...
		obj->radius = 102;
		obj->pivot_length = 0;
		obj->bite_offset[0] = WHITE_SOLDIER_BITE;
		obj->intelligent = 1;
		obj->save_position = 1;
		obj->save_hitpoints = 1;
		obj->save_flags = 1;
	...
	if (obj->loaded)
	{
		...
		obj->radius = 102;
		obj->pivot_length = 0;
		obj->bite_offset[0] = SWAT_GUN_BITE;
		obj->intelligent = 1;
		obj->save_position = 1;
		obj->save_hitpoints = 1;
		obj->save_flags = 1;
	...
	if (obj->loaded)
	{
		...
		obj->radius = 102;
		obj->pivot_length = 0;
		obj->bite_offset[0] = ARMYSMG_GUN_BITE;
		obj->intelligent = 1;
		obj->save_position = 1;
		obj->save_hitpoints = 1;
		obj->save_flags = 1;
...
void InitialiseObjects()
{
	...
	for (lp = 0; lp < NUMBER_OBJECTS; lp++)
	{
		...
		obj->bite_offset[0] = NO_BITE_OFFSET;
		obj->bite_offset[1] = NO_BITE_OFFSET;
	}
